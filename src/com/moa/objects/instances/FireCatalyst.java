...
public class FireCatalyst extends AbstractMoaObject
{
	...
	public static Map<UUID, Integer> comboTier = new HashMap<>();
	public static Map<UUID, Boolean> comboEndNaturally = new HashMap<>();

	public static Map<UUID, Boolean> isChanneled = new HashMap<>();
	public static Map<UUID, Boolean> isHyperCasting = new HashMap<>();
	
	public static Map<UUID, Integer> combo2Tier = new HashMap<>();
	public static Map<UUID, Boolean> combo2EndNaturally = new HashMap<>();
	...
	public boolean Cast(PlayerInteractEvent e) 
	{
		...
		if (MoaPlayerActions.shiftLeftClickAir(e)) 
		{
			...
			if (isHyperCasting.get(uuid) == null) 
			{
			...
			//Execute toggle
			if (Boolean.TRUE.equals(isHyperCasting.get(uuid))) 
			{
		...
		if (MoaPlayerActions.rightClickAir(e)) 
		{
			...
			//Unchanneled Magiks:
			if (isChanneled.get(uuid).equals(false)) 
			{
			...
			if (isChanneled.get(uuid).equals(true)) 
			{
